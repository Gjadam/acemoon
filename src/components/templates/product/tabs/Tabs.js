  ...
  return (
    <div className=" my-28">
        ...
        <Image
            ...
            <button className={` w-full md:w-40 h-12  hover:bg-rose-500 hover:text-white ${active === 'comments' ? ' bg-rose-500 text-white' : 'bg-zinc-100 text-secondary'} rounded-3xl transition-colors`} onClick={() => setActive("comments")}>نظرات(0)</button>
            <Image
                        alt='logo'
                        src={'/images/png/flower1.png'}
                        width={100}
